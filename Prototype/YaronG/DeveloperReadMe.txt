...
The following basically describes the dependency relationships of the three 'active' projects in this sub-directory and how to build the project:
...
1 - DesktopMiniBlogger depends on the file LiveConnectPrototype.jar being physically in the DesktopMiniBlogger sub-directory. This jar file is produced by:
	...
	Step 1 - Build/Build Artifacts, this produces the file LiveConnectPrototype.jar in \LiveConnectPrototype\LiveConnectPrototype\out\artifacts\LiveConnectPrototype_jar\.
	Step 2 - Sign the jar file by executing something along the lines of "c:\Program Files (x86)\Java\jdk1.7.0_40\bin\jarsigner.exe" [previouspath]\LiveConnectPrototype.jar [the id you choose in setup]. You will then be prompted for your signing key.
