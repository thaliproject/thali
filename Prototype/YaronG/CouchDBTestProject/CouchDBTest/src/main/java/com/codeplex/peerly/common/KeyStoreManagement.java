...
/**
 * Contains classes to handle creating key stores and putting keys into them
 */
public class KeyStoreManagement {
    ...
    private final static int KeySizeInBits = 512; // TODO: This is short to make testing easy but in practice it should be at least 2k
    ...
    private final static Logger Log = LoggerFactory.getLogger(KeyStoreManagement.class);
     ...
     * @return
     */
    public static KeyStore CreatePKCS12KeyStoreWithNewPublicPrivateKeyPair(KeyPair keyPair, String keyAlias, char[] passphrase) {
        try {
