...
public class JavaEktorpCreateClientBuilderTest {
    ...
    public void testClient()
        ...
        ThaliTestEktorpClient.runRetrieveTest(ThaliListener.DefaultThaliDeviceHubAddress, ThaliListener.DefaultThaliDeviceHubPort, new JavaEktorpCreateClientBuilder(), localDirectory);
    }
}
